...
abstract class DynamicImagesToolBase extends ToolBase {
    ...
    public function __construct($toolName, $toolInfo, $toolManager) {
        ...
        add_filter('ilab_dynamic_images_enabled', function($enabled){
            if (!$enabled) {
                return $this->enabled();
            }
    ...
    abstract protected function buildSizedImage($id, $size);
    abstract protected function buildImage($id, $size, $params = null, $skipParams = false, $mergeParams = null, $newSize = null, $newMeta=null);

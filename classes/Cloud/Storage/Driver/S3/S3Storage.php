...
class S3Storage implements StorageInterface {
	...
	public function enabled() {
		if(!($this->key && $this->secret && $this->bucket)) {
			...
			NoticeManager::instance()->displayAdminNotice('error', "To start using Cloud Storage, you will need to <a href='$adminUrl'>supply your AWS credentials.</a>.", true, 'ilab-cloud-storage-setup-warning', 'forever');
